...
namespace AdvanceCRM.ThirdParty.Repositories
{
    ...
    public class KnowlarityDetailsRepository : BaseRepository
    {
    public KnowlarityDetailsRepository(IRequestContext context) : base(context) { }
        ...
        public class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void BeforeSave()
            {
                ...
                //Serilog.Log.Information("Old Entity: {@Old}", Old);
                //Serilog.Log.Information("New Entity: {@Row}", Row);
            }            
        }
