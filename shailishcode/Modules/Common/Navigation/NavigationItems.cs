...
[assembly: NavigationLink(1452, "Purchase/GrnTwo", typeof(GrnTwoController), icon: "fa-truck", Permission = "GrnTwo:Read", Title = "GRN")]
[assembly: NavigationLink(1453, "Purchase/Purchase", typeof(PurchaseController), icon: "icon-basket-loaded", Permission = "Purchase:Read", Title = "Purchase")]
[assembly: NavigationLink(1454, "Purchase/Purchase Return", typeof(PurchaseReturnController), icon: "fa-reply-all", Permission = "PurchaseReturn:Read", Title = "Purchase Return")]
...
[assembly: NavigationLink(6009, "Reports/Sales", typeof(SalesReportController), icon: "fa-exchange", Permission = "Reports:Accounting", Title = "Sales")]
...
[assembly: NavigationLink(6564, "Reports/Followups/Sales", typeof(SalesFollowupsController), icon: "icon-docs", Permission = "Reports:Sales:Followups")]
[assembly: NavigationLink(6565, "Reports/Followups/TeleCalling", typeof(TeleCallingFollowupsController), icon: "fa-phone", Permission = "Reports:TeleCalling:Followups")]
