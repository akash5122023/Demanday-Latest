...
{
    public class SubContactController : ApiController
    {
        List<SubContactModel> Contact;
        public SubContactController()
        {
            Contact = new List<SubContactModel>();
        }
       // public IEnumerable<SubContactModel> Get([FromUri] EnquiryNModel pagingparametermodel)
        ...
        //public IEnumerable<SubContactModel> Get( string id, [FromUri] EnquiryNModel pagingparametermodel)
