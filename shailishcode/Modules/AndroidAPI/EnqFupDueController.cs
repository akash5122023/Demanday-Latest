...
{
    public class EnqFupDueController : ApiController
    {
        List<EnquiryFollowupModel> Contact;
        public EnqFupDueController()
        {
...

        {
            ...
            //con.Open();
            string dt = DateTime.Now.ToString("yyyy-MM-dd") + " 00:00:00.000";
            string str= "Select cn.Name,cn.Phone,enq.EnquiryN,enq.EnquiryNo,enq.StageID,enq.SourceID,sr.Source,st.Stage,en.Id,en.EnquiryId,en.FollowUpDate,en.Status,en.FollowUpNote,en.Details,us.DisplayName from EnquiryFollowUps en, Enquiry enq,Source sr, Stage st,Users us, Contacts cn where en.RepresentativeId = us.UserId and enq.ContactsId = cn.Id and en.EnquiryId = enq.Id and st.Id = enq.stageId and sr.Id = enq.SourceId and en.FollowupDate < '" + dt + "' and en.RepresentativeId =" + id+" ORDER BY en.Id DESC";

           // string str = "Select en.Id,en.FollowUpDate,Status,en.FollowUpNote,en.Details,us.DisplayName from EnquiryFollowUps en,Users us where en.RepresentativeId=us.UserId and en.FollowupDate < '" + dt + "' and en.RepresentativeId =" + id;
