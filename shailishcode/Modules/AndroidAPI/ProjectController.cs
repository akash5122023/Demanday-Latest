...
namespace AdvanceCRM.Modules.AndroidAPI
{
    public class ProjectController : ApiController
    {
      ...
      //  public IEnumerable<ProjectModel> Get([FromUri] EnquiryNModel pagingparametermodel)
        ...
        //public IEnumerable<ProjectModel> Get(string id, [FromUri] EnquiryNModel pagingparametermodel)
