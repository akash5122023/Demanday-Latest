...
namespace AdvanceCRM.Masters
{
    ...
    [ConnectionKey("Default"), Module("Masters"), TableName("[dbo].[Stage]")]
    [DisplayName("Stage"), InstanceName("Stage")]
    [ReadPermission("Masters:Read")]
    [ModifyPermission("Masters:Modify")]
    [LookupScript("Masters.Stage", Permission = "?")]
    public sealed class StageRow : Row<StageRow.RowFields>, IIdRow, INameRow, _Ext.IAuditLog
    {
        ...
        [DisplayName("Stage"), Size(200), NotNull, QuickSearch,NameProperty]
        public String Stage
        {
        ...
        public StageTypeMaster? Type
        {
            get { return (StageTypeMaster?)Fields.Type[this]; }
            set { Fields.Type[this] = (Int32?)value; }
        }

        [DisplayName("Company"), ForeignKey("[dbo].[CompanyDetails]", "Id"), LeftJoin("jCompany"), TextualField("CompanyName")]
        ...
        public StageRow(RowFields fields)
            : base(Fields)
        {
        }
