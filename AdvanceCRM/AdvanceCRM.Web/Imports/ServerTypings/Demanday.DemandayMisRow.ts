namespace AdvanceCRM.Demanday {
    export interface DemandayMisRow {
        Id?: number;
        AgentsName?: string;
        TlName?: string;
        CampaignId?: string;
    ...
    export namespace DemandayMisRow {
        ...
        export const localTextPrefix = 'Demanday.DemandayMis';
        export const lookupKey = 'Demanday.DemandayMIS';

        export function getLookup(): Q.Lookup<DemandayMisRow> {
            return Q.getLookup<DemandayMisRow>('Demanday.DemandayMIS');
        }
        export const deletePermission = 'DemandayMIS:Delete';
        export const insertPermission = 'DemandayMIS:Insert';
        export const readPermission = 'DemandayMIS:Read';
        export const updatePermission = 'DemandayMIS:Update';
