namespace AdvanceCRM.Toolkit {
    export namespace MasterSupressionService {
        ...
        export declare function ExcelImport(request: MasterSupressionExcelImportRequest, onSuccess?: (response: ExcelImportResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
