namespace AdvanceCRM.Toolkit {
    export namespace TalCampaignService {
        ...
        export declare function ExcelImport(request: TalCampaignExcelImportRequest, onSuccess?: (response: ExcelImportResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
