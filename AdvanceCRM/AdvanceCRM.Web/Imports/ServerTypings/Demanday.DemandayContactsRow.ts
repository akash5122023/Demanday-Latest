namespace AdvanceCRM.Demanday {
    export interface DemandayContactsRow {
        Id?: number;
        AgentsName?: string;
        TlName?: string;
        CampaignId?: string;
    ...
    export namespace DemandayContactsRow {
        export const idProperty = 'Id';
        export const nameProperty = 'AgentsName';
        export const localTextPrefix = 'Demanday.DemandayContacts';
        export const lookupKey = 'Demanday.DemandayContacts';

        export function getLookup(): Q.Lookup<DemandayContactsRow> {
            return Q.getLookup<DemandayContactsRow>('Demanday.DemandayContacts');
        }
        export const deletePermission = 'DemandayContacts:Delete';
        export const insertPermission = 'DemandayContacts:Insert';
        export const readPermission = 'DemandayContacts:Read';
        export const updatePermission = 'DemandayContacts:Update';
