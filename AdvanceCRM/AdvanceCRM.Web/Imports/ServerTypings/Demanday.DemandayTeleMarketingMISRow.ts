namespace AdvanceCRM.Demanday {
    ...
    export namespace DemandayTeleMarketingMISRow {
        ...
        export const localTextPrefix = 'Demanday.DemandayTeleMarketingMIS';
        export const lookupKey = 'Demanday.DemandayTeleMarketingMIS';

        export function getLookup(): Q.Lookup<DemandayTeleMarketingMISRow> {
            return Q.getLookup<DemandayTeleMarketingMISRow>('Demanday.DemandayTeleMarketingMIS');
        }
        export const deletePermission = 'DemandayTeleMarketingMIS:Delete';
        export const insertPermission = 'DemandayTeleMarketingMIS:Insert';
        export const readPermission = 'DemandayTeleMarketingMIS:Read';
