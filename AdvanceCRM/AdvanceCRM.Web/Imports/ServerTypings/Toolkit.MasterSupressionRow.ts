namespace AdvanceCRM.Toolkit {
    export interface MasterSupressionRow {
        Id?: number;
        CampaignId?: number;
        CompanyName?: string;
        FirstName?: string;
    ...
    export namespace MasterSupressionRow {
        export const idProperty = 'Id';
        export const nameProperty = 'CompanyName';
        export const localTextPrefix = 'Toolkit.MasterSupression';
        export const lookupKey = 'MasterSupression.MasterSupression';

        export function getLookup(): Q.Lookup<MasterSupressionRow> {
            return Q.getLookup<MasterSupressionRow>('MasterSupression.MasterSupression');
        }
        export const deletePermission = 'MasterSupression:Delete';
        export const insertPermission = 'MasterSupression:Insert';
        export const readPermission = 'MasterSupression:Read';
        export const updatePermission = 'MasterSupression:Update';
