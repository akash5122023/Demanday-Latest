namespace AdvanceCRM.Demanday {
    export interface DemandayQualityRow {
        Id?: number;
        AgentsName?: string;
        TlName?: string;
        CampaignId?: string;
    ...
    export namespace DemandayQualityRow {
        export const idProperty = 'Id';
        export const nameProperty = 'AgentsName';
        export const localTextPrefix = 'Demanday.DemandayQuality';
        export const lookupKey = 'Demanday.DemandayQuality';

        export function getLookup(): Q.Lookup<DemandayQualityRow> {
            return Q.getLookup<DemandayQualityRow>('Demanday.DemandayQuality');
        }
        export const deletePermission = 'DemandayQuality:Delete';
        export const insertPermission = 'DemandayQuality:Insert';
        export const readPermission = 'DemandayQuality:Read';
        export const updatePermission = 'DemandayQuality:Update';
