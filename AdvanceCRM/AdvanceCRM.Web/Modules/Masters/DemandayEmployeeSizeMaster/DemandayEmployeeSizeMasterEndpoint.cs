...
{
    [Route("Services/Masters/DemandayEmployeeSizeMaster/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class DemandayEmployeeSizeMasterController : ServiceEndpoint
    {
        [HttpPost, AuthorizeCreate(typeof(MyRow))]
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
            [FromServices] IDemandayEmployeeSizeMasterSaveHandler handler)
        {
        ...
        public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
            [FromServices] IDemandayEmployeeSizeMasterDeleteHandler handler)
        {
        ...
        public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
            [FromServices] IDemandayEmployeeSizeMasterRetrieveHandler handler)
        {
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
            [FromServices] IDemandayEmployeeSizeMasterListHandler handler)
        {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.DemandayEmployeeSizeMasterColumns), request.ExportColumns);
            return ExcelContentResult.Create(bytes, "DemandayEmployeeSizeMasterList_" +
