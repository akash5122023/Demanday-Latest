...
{
    [Route("Services/Masters/DemandayJobLevelMaster/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class DemandayJobLevelMasterController : ServiceEndpoint
    {
        [HttpPost, AuthorizeCreate(typeof(MyRow))]
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
            [FromServices] IDemandayJobLevelMasterSaveHandler handler)
        {
        ...
        public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
            [FromServices] IDemandayJobLevelMasterDeleteHandler handler)
        {
        ...
        public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
            [FromServices] IDemandayJobLevelMasterRetrieveHandler handler)
        {
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
            [FromServices] IDemandayJobLevelMasterListHandler handler)
        {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.DemandayJobLevelMasterColumns), request.ExportColumns);
            return ExcelContentResult.Create(bytes, "DemandayJobLevelMasterList_" +
