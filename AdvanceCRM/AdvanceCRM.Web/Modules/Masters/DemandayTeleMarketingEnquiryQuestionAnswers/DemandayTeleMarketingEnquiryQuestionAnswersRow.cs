...
{
    [ConnectionKey("Default"), Module("Masters"), TableName("[dbo].[DemandayTeleMarketingEnquiryQuestionAnswers]")]
    [DisplayName("Demanday Tele Marketing Enquiry Question Answers"), InstanceName("Demanday Tele Marketing Enquiry Question Answers")]
    [ReadPermission("Masters:Read")]
    [ModifyPermission("Masters:Modify")]
    [LookupScript("Masters.DemandayTeleMarketingEnquiryQuestionAnswers", Permission = "?")]
    public sealed class DemandayTeleMarketingEnquiryQuestionAnswersRow : Row<DemandayTeleMarketingEnquiryQuestionAnswersRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Answer Text"), Size(500), QuickSearch, NameProperty]
        ...
        [DisplayName("Question Text"), Expression("jQuestion.[QuestionText]")]
        public String QuestionQuestionText
        {
            get => fields.QuestionQuestionText[this];
            set => fields.QuestionQuestionText[this] = value;
        }

        [DisplayName("Question Campaign Id"), Expression("jQuestion.[CampaignId]")]
        public Int32? QuestionCampaignId
        {
            get => fields.QuestionCampaignId[this];
            set => fields.QuestionCampaignId[this] = value;
        }

        [DisplayName("Question Owner Id"), Expression("jQuestion.[OwnerId]")]
        public Int32? QuestionOwnerId
        {
            get => fields.QuestionOwnerId[this];
            set => fields.QuestionOwnerId[this] = value;
        }
        ...
        public DemandayTeleMarketingEnquiryQuestionAnswersRow()
            : base()
        {
        }

        public DemandayTeleMarketingEnquiryQuestionAnswersRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField QuestionQuestionText;
            public Int32Field QuestionCampaignId;
            public Int32Field QuestionOwnerId;
