...
{
    [Route("Services/Masters/DemandayJobFunctionMaster/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class DemandayJobFunctionMasterController : ServiceEndpoint
    {
        [HttpPost, AuthorizeCreate(typeof(MyRow))]
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
            [FromServices] IDemandayJobFunctionMasterSaveHandler handler)
        {
        ...
        public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
            [FromServices] IDemandayJobFunctionMasterDeleteHandler handler)
        {
        ...
        public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
            [FromServices] IDemandayJobFunctionMasterRetrieveHandler handler)
        {
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
            [FromServices] IDemandayJobFunctionMasterListHandler handler)
        {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.DemandayJobFunctionMasterColumns), request.ExportColumns);
            return ExcelContentResult.Create(bytes, "DemandayJobFunctionMasterList_" +
