...
{
    [Route("Services/Masters/DemandaySubIndustryMaster/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class DemandaySubIndustryMasterController : ServiceEndpoint
    {
        [HttpPost, AuthorizeCreate(typeof(MyRow))]
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request,
            [FromServices] IDemandaySubIndustryMasterSaveHandler handler)
        {
        ...
        public DeleteResponse Delete(IUnitOfWork uow, DeleteRequest request,
            [FromServices] IDemandaySubIndustryMasterDeleteHandler handler)
        {
        ...
        public RetrieveResponse<MyRow> Retrieve(IDbConnection connection, RetrieveRequest request,
            [FromServices] IDemandaySubIndustryMasterRetrieveHandler handler)
        {
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request,
            [FromServices] IDemandaySubIndustryMasterListHandler handler)
        {
            ...
            [FromServices] IExcelExporter exporter)
        {
            ...
            var bytes = exporter.Export(data, typeof(Columns.DemandaySubIndustryMasterColumns), request.ExportColumns);
            return ExcelContentResult.Create(bytes, "DemandaySubIndustryMasterList_" +
