...
{
    [ConnectionKey("Default"), Module("Masters"), TableName("[dbo].[DemandayTeleMarketingEnquiryCampaignQuestions]")]
    [DisplayName("Demanday Tele Marketing Enquiry Campaign Questions"), InstanceName("Demanday Tele Marketing Enquiry Campaign Questions")]
    [ReadPermission("Masters:Read")]
    [ModifyPermission("Masters:Modify")]
    [LookupScript("Masters.DemandayTeleMarketingEnquiryCampaignQuestions", Permission = "?")]
    public sealed class DemandayTeleMarketingEnquiryCampaignQuestionsRow : Row<DemandayTeleMarketingEnquiryCampaignQuestionsRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Question Text"), Size(500), NotNull, QuickSearch, NameProperty]
        ...
        public DemandayTeleMarketingEnquiryCampaignQuestionsRow()
            : base()
        {
        }

        public DemandayTeleMarketingEnquiryCampaignQuestionsRow(RowFields fields)
            : base(fields)
        {
        }
