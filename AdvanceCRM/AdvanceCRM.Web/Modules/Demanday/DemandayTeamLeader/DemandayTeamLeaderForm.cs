...
{
    [FormScript("Demanday.DemandayTeamLeader")]
    [BasedOnRow(typeof(DemandayTeamLeaderRow), CheckNames = true)]
    public class DemandayTeamLeaderForm
    {
        //public Int32 DemandayEnquiryId { get; set; }
