...
{
    [ConnectionKey("Default"), Module("Demanday"), TableName("[dbo].[DemandayMIS]")]
    [DisplayName("Demanday Mis"), InstanceName("Demanday Mis")]
    [ReadPermission("DemandayMIS:Read")]
    [InsertPermission("DemandayMIS:Insert")]
    [UpdatePermission("DemandayMIS:Update")]
    [DeletePermission("DemandayMIS:Delete")]
    [LookupScript("Demanday.DemandayMIS", Permission = "?")]
    public sealed class DemandayMisRow : Row<DemandayMisRow.RowFields>, IIdRow, INameRow
    {
        ...
        public DemandayMisRow(RowFields fields)
            : base(fields)
        {
        }
