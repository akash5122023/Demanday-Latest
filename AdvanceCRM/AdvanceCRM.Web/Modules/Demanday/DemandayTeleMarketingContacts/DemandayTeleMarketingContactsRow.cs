...
{
    [ConnectionKey("Default"), Module("Demanday"), TableName("[dbo].[DemandayTeleMarketingContacts]")]
    [DisplayName("TM Contacts"), InstanceName("Demanday Tele Marketing Contacts")]
    [ReadPermission("DemandayTeleMarketingContacts:Read")]
    [InsertPermission("DemandayTeleMarketingContacts:Insert")]
    [UpdatePermission("DemandayTeleMarketingContacts:Update")]
    [DeletePermission("DemandayTeleMarketingContacts:Delete")]
    [LookupScript("Demanday.DemandayTeleMarketingContacts", Permission = "?")]
    public sealed class DemandayTeleMarketingContactsRow : Row<DemandayTeleMarketingContactsRow.RowFields>, IIdRow, INameRow
    {
        ...
        public String ProspectUrl
        {
            ...
            set => fields.ProspectUrl[this] = value;
        }
        ...
        public DemandayTeleMarketingContactsRow()
            : base()
        {
        }

        public DemandayTeleMarketingContactsRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField ProspectUrl;
