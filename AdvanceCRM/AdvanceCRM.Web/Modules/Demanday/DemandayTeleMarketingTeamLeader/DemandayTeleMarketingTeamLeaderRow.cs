...
{
    [ConnectionKey("Default"), Module("Demanday"), TableName("[dbo].[DemandayTeleMarketingTeamLeader]")]
    [DisplayName("TM TeamLeader"), InstanceName("Demanday Tele Marketing Team Leader")]
    [ReadPermission("DemandayTeleMarketingTeamLeader:Read")]
    [InsertPermission("DemandayTeleMarketingTeamLeader:Insert")]
    [UpdatePermission("DemandayTeleMarketingTeamLeader:Update")]
    [DeletePermission("DemandayTeleMarketingTeamLeader:Delete")]
    [LookupScript("Demanday.DemandayTeleMarketingTeamLeader", Permission = "?")]
    public sealed class DemandayTeleMarketingTeamLeaderRow : Row<DemandayTeleMarketingTeamLeaderRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Tele Marketing Enquiry"), Column("TeleMarketingEnquiryID"), ForeignKey("[dbo].[DemandayTeleMarketingEnquiry]", "Id"), LeftJoin("jTeleMarketingEnquiry"), TextualField("TeleMarketingEnquiryCompanyName")]
        public Int32? TeleMarketingEnquiryId
        {
            get => fields.TeleMarketingEnquiryId[this];
            set => fields.TeleMarketingEnquiryId[this] = value;
        }
...
public String EmailFormat
{
    ...
    set => fields.EmailFormat[this] = value;
        ...
        [DisplayName("Tele Marketing Enquiry Company Name"), Expression("jTeleMarketingEnquiry.[CompanyName]")]
        public String TeleMarketingEnquiryCompanyName
        {
            get => fields.TeleMarketingEnquiryCompanyName[this];
            set => fields.TeleMarketingEnquiryCompanyName[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry First Name"), Expression("jTeleMarketingEnquiry.[FirstName]")]
        public String TeleMarketingEnquiryFirstName
        {
            get => fields.TeleMarketingEnquiryFirstName[this];
            set => fields.TeleMarketingEnquiryFirstName[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Last Name"), Expression("jTeleMarketingEnquiry.[LastName]")]
        public String TeleMarketingEnquiryLastName
        {
            get => fields.TeleMarketingEnquiryLastName[this];
            set => fields.TeleMarketingEnquiryLastName[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Title"), Expression("jTeleMarketingEnquiry.[Title]")]
        public String TeleMarketingEnquiryTitle
        {
            get => fields.TeleMarketingEnquiryTitle[this];
            set => fields.TeleMarketingEnquiryTitle[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Email"), Expression("jTeleMarketingEnquiry.[Email]")]
        public String TeleMarketingEnquiryEmail
        {
            get => fields.TeleMarketingEnquiryEmail[this];
            set => fields.TeleMarketingEnquiryEmail[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Work Phone"), Expression("jTeleMarketingEnquiry.[WorkPhone]")]
        public String TeleMarketingEnquiryWorkPhone
        {
            get => fields.TeleMarketingEnquiryWorkPhone[this];
            set => fields.TeleMarketingEnquiryWorkPhone[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Alternative Number"), Expression("jTeleMarketingEnquiry.[AlternativeNumber]")]
        public String TeleMarketingEnquiryAlternativeNumber
        {
            get => fields.TeleMarketingEnquiryAlternativeNumber[this];
            set => fields.TeleMarketingEnquiryAlternativeNumber[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Street"), Expression("jTeleMarketingEnquiry.[Street]")]
        public String TeleMarketingEnquiryStreet
        {
            get => fields.TeleMarketingEnquiryStreet[this];
            set => fields.TeleMarketingEnquiryStreet[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry City"), Expression("jTeleMarketingEnquiry.[City]")]
        public String TeleMarketingEnquiryCity
        {
            get => fields.TeleMarketingEnquiryCity[this];
            set => fields.TeleMarketingEnquiryCity[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry State"), Expression("jTeleMarketingEnquiry.[State]")]
        public String TeleMarketingEnquiryState
        {
            get => fields.TeleMarketingEnquiryState[this];
            set => fields.TeleMarketingEnquiryState[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Zip Code"), Expression("jTeleMarketingEnquiry.[ZipCode]")]
        public String TeleMarketingEnquiryZipCode
        {
            get => fields.TeleMarketingEnquiryZipCode[this];
            set => fields.TeleMarketingEnquiryZipCode[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Country"), Expression("jTeleMarketingEnquiry.[Country]")]
        public String TeleMarketingEnquiryCountry
        {
            get => fields.TeleMarketingEnquiryCountry[this];
            set => fields.TeleMarketingEnquiryCountry[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Company Employee Size"), Expression("jTeleMarketingEnquiry.[CompanyEmployeeSize]")]
        public Int32? TeleMarketingEnquiryCompanyEmployeeSize
        {
            get => fields.TeleMarketingEnquiryCompanyEmployeeSize[this];
            set => fields.TeleMarketingEnquiryCompanyEmployeeSize[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Industry"), Expression("jTeleMarketingEnquiry.[Industry]")]
        public String TeleMarketingEnquiryIndustry
        {
            get => fields.TeleMarketingEnquiryIndustry[this];
            set => fields.TeleMarketingEnquiryIndustry[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Revenue"), Expression("jTeleMarketingEnquiry.[Revenue]")]
        public Decimal? TeleMarketingEnquiryRevenue
        {
            get => fields.TeleMarketingEnquiryRevenue[this];
            set => fields.TeleMarketingEnquiryRevenue[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Profile Link"), Expression("jTeleMarketingEnquiry.[ProfileLink]")]
        public String TeleMarketingEnquiryProfileLink
        {
            get => fields.TeleMarketingEnquiryProfileLink[this];
            set => fields.TeleMarketingEnquiryProfileLink[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Company Link"), Expression("jTeleMarketingEnquiry.[CompanyLink]")]
        public String TeleMarketingEnquiryCompanyLink
        {
            get => fields.TeleMarketingEnquiryCompanyLink[this];
            set => fields.TeleMarketingEnquiryCompanyLink[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Revenue Link"), Expression("jTeleMarketingEnquiry.[RevenueLink]")]
        public String TeleMarketingEnquiryRevenueLink
        {
            get => fields.TeleMarketingEnquiryRevenueLink[this];
            set => fields.TeleMarketingEnquiryRevenueLink[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Address Link"), Expression("jTeleMarketingEnquiry.[AddressLink]")]
        public String TeleMarketingEnquiryAddressLink
        {
            get => fields.TeleMarketingEnquiryAddressLink[this];
            set => fields.TeleMarketingEnquiryAddressLink[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Tenurity"), Expression("jTeleMarketingEnquiry.[Tenurity]")]
        public String TeleMarketingEnquiryTenurity
        {
            get => fields.TeleMarketingEnquiryTenurity[this];
            set => fields.TeleMarketingEnquiryTenurity[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Code"), Expression("jTeleMarketingEnquiry.[Code]")]
        public String TeleMarketingEnquiryCode
        {
            get => fields.TeleMarketingEnquiryCode[this];
            set => fields.TeleMarketingEnquiryCode[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Link"), Expression("jTeleMarketingEnquiry.[Link]")]
        public String TeleMarketingEnquiryLink
        {
            get => fields.TeleMarketingEnquiryLink[this];
            set => fields.TeleMarketingEnquiryLink[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Md5"), Expression("jTeleMarketingEnquiry.[Md5]")]
        public String TeleMarketingEnquiryMd5
        {
            get => fields.TeleMarketingEnquiryMd5[this];
            set => fields.TeleMarketingEnquiryMd5[this] = value;
        }

        [DisplayName("Tele Marketing Enquiry Owner Id"), Expression("jTeleMarketingEnquiry.[OwnerId]")]
        public Int32? TeleMarketingEnquiryOwnerId
        {
            get => fields.TeleMarketingEnquiryOwnerId[this];
            set => fields.TeleMarketingEnquiryOwnerId[this] = value;
        }
        ...
        public DemandayTeleMarketingTeamLeaderRow()
            : base()
        {
        }

        public DemandayTeleMarketingTeamLeaderRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field TeleMarketingEnquiryId;
            ...
            public StringField TeleMarketingEnquiryLastName;
            public StringField TeleMarketingEnquiryTitle;
            public StringField TeleMarketingEnquiryEmail;
            public StringField TeleMarketingEnquiryWorkPhone;
            public StringField TeleMarketingEnquiryAlternativeNumber;
            public StringField TeleMarketingEnquiryStreet;
            public StringField TeleMarketingEnquiryCity;
            public StringField TeleMarketingEnquiryState;
            public StringField TeleMarketingEnquiryZipCode;
            public StringField TeleMarketingEnquiryCountry;
            public Int32Field TeleMarketingEnquiryCompanyEmployeeSize;
            public StringField TeleMarketingEnquiryIndustry;
            public DecimalField TeleMarketingEnquiryRevenue;
            public StringField TeleMarketingEnquiryProfileLink;
            public StringField TeleMarketingEnquiryCompanyLink;
            public StringField TeleMarketingEnquiryRevenueLink;
            public StringField TeleMarketingEnquiryAddressLink;
            public StringField TeleMarketingEnquiryTenurity;
            public StringField TeleMarketingEnquiryCode;
            public StringField TeleMarketingEnquiryLink;
            public StringField TeleMarketingEnquiryMd5;
            public Int32Field TeleMarketingEnquiryOwnerId;
