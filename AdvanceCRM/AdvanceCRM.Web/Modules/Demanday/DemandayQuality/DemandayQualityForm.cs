...
{
    [FormScript("Demanday.DemandayQuality")]
    [BasedOnRow(typeof(DemandayQualityRow), CheckNames = true)]
    public class DemandayQualityForm
    {
        ...
        [OneThirdWidth]
        public string DeliveryStatus { get; set; }
        // Owned by the Email Team module – shown here read-only. See EmailTeamSaveHandler.
        [OneThirdWidth]
