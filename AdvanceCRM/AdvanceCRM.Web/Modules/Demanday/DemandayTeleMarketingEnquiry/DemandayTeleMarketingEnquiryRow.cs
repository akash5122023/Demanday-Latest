...
{
    [ConnectionKey("Default"), Module("Demanday"), TableName("[dbo].[DemandayTeleMarketingEnquiry]")]
    [DisplayName("TM Enquiry"), InstanceName("Demanday Tele Marketing Enquiry")]
    ...
    [LookupScript("Demanday.DemandayTeleMarketingEnquiry", Permission = "DemandayTeleMarketingEnquiry:Insert")]
    public sealed class DemandayTeleMarketingEnquiryRow : Row<DemandayTeleMarketingEnquiryRow.RowFields>, IIdRow, INameRow
    {
        ...
        public DemandayTeleMarketingEnquiryRow(RowFields fields)
            : base(fields)
        {
        }
