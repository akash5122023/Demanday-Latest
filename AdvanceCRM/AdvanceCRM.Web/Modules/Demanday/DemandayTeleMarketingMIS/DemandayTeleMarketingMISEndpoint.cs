                    ...
                    for (int row = 2; row <= rowCount; row++)
                    {
                        try
                        {
                            var demandaytelemarketingmis = new DemandayTeleMarketingMISRow
                            {
                                ...
                                CampaignId = ws.Cells[row, 12].Text,
                                ...
                                CompanyEmployeeSize = ws.Cells[row, 18].Text,
                                Industry = ws.Cells[row, 19].Text,
                                Revenue = ws.Cells[row, 20].Text,
                                ProfileLink = ws.Cells[row, 21].Text,
                                CompanyLink = ws.Cells[row, 22].Text,
                                RevenueLink = ws.Cells[row, 23].Text,
                                //EmailFormat = ws.Cells[row, 24].Text,
                                ...
                                OwnerUsername = ws.Cells[row, 43].Text
                            };
