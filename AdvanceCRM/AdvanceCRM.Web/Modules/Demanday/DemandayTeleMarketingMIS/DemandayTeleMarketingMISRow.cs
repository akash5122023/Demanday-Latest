...
{
    [ConnectionKey("Default"), Module("Demanday"), TableName("[dbo].[DemandayTeleMarketingMIS]")]
    [DisplayName("TM MIS"), InstanceName("Demanday Tele Marketing Mis")]
    [ReadPermission("DemandayTeleMarketingMIS:Read")]
    [InsertPermission("DemandayTeleMarketingMIS:Insert")]
    [UpdatePermission("DemandayTeleMarketingMIS:Update")]
    [DeletePermission("DemandayTeleMarketingMIS:Delete")]
    [LookupScript("Demanday.DemandayTeleMarketingMIS", Permission = "?")]
    public sealed class DemandayTeleMarketingMISRow : Row<DemandayTeleMarketingMISRow.RowFields>, IIdRow, INameRow
    {
        ...
        public DemandayTeleMarketingMISRow(RowFields fields)
            : base(fields)
        {
        }
