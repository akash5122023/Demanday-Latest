...
{
    [ConnectionKey("Default"), Module("Demanday"), TableName("[dbo].[DemandayContacts]")]
    [DisplayName("Demanday Contacts"), InstanceName("Demanday Contacts")]
    [ReadPermission("DemandayContacts:Read")]
    [InsertPermission("DemandayContacts:Insert")]
    [UpdatePermission("DemandayContacts:Update")]
    [DeletePermission("DemandayContacts:Delete")]
    [LookupScript("Demanday.DemandayContacts", Permission = "?")]
    public sealed class DemandayContactsRow : Row<DemandayContactsRow.RowFields>, IIdRow, INameRow
    {
        ...
        public DemandayContactsRow()
            : base()
        {
        }

        public DemandayContactsRow(RowFields fields)
            : base(fields)
        {
        }
