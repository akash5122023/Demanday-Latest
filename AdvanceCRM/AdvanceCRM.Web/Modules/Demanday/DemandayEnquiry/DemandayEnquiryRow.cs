...
{
    [ConnectionKey("Default"), Module("Demanday"), TableName("[dbo].[DemandayEnquiry]")]
    [DisplayName("Demanday Enquiry"), InstanceName("Demanday Enquiry")]
    [ReadPermission("DemandayEnquiry:Read")]
    [InsertPermission("DemandayEnquiry:Insert")]
    [UpdatePermission("DemandayEnquiry:Update")]
    [DeletePermission("DemandayEnquiry:Delete")]
    [LookupScript("Demanday.DemandayEnquiry", Permission = "DemandayEnquiry:Insert")]
    public sealed class DemandayEnquiryRow : Row<DemandayEnquiryRow.RowFields>, IIdRow, INameRow
    {
...
public String EmailFormat
{
    ...
    set => fields.EmailFormat[this] = value;
        ...
        public DemandayEnquiryRow(RowFields fields)
            : base(fields)
        {
        }
