using AdvanceCRM.TeleMarketingEmailTeam;
using OfficeOpenXml;
using System.Collections.Generic;

namespace AdvanceCRM.Web.Modules.Common.AppServices
{
    public class TeleMarketingEmailTeamExcelExporter
    {
        // The columns the TM Email Team form offers, plus Id. Account, campaign and owner go out
        // as their readable values so the sheet can be read - and imported back - without ids.
        ...
        public static byte[] ExportToExcel(List<TeleMarketingEmailTeamRow> teleMarketingEmailTeamRows)
        {
            ...
            int row = 2;
            foreach (var en in teleMarketingEmailTeamRows)
            {
                int col = 1;
