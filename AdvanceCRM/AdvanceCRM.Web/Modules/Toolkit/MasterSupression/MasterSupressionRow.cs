...
{
    [ConnectionKey("Default"), Module("Toolkit"), TableName("[dbo].[MasterSupression]")]
    [DisplayName("Master Supression"), InstanceName("Master Supression")]
    [ReadPermission("MasterSupression:Read")]
    [InsertPermission("MasterSupression:Insert")]
    ...
    public sealed class MasterSupressionRow : Row<MasterSupressionRow.RowFields>, IIdRow, INameRow
    {
        ...
        public MasterSupressionRow()
            : base()
        {
        }

        public MasterSupressionRow(RowFields fields)
            : base(fields)
        {
        }
