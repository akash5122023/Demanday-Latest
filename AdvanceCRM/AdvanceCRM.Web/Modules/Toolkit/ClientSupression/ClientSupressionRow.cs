...
{
    [ConnectionKey("Default"), Module("Toolkit"), TableName("[dbo].[ClientSupression]")]
    [DisplayName("Client Supression"), InstanceName("Client Supression")]
    [ReadPermission("ClientSupression:Read")]
    [InsertPermission("ClientSupression:Insert")]
    [UpdatePermission("ClientSupression:Update")]
    [DeletePermission("ClientSupression:Delete")]
    [LookupScript("ClientSupression.ClientSupression", Permission = "ClientSupression:Read")]
    public sealed class ClientSupressionRow : Row<ClientSupressionRow.RowFields>, IIdRow, INameRow
    {
        ...
        //[DisplayName("Campaign Id"), Size(15), QuickSearch, ]
        ...
        //[DisplayName("Master Account"), ForeignKey("[dbo].[MasterSupression]", "Id"), LeftJoin("jMasterAccount"), TextualField("MasterAccountCampaignId")]
        ...
        //[DisplayName("Master Account Campaign Id"), Expression("jMasterAccount.[CampaignId]")]
        //public String MasterAccountCampaignId
        //{
        //    get => fields.MasterAccountCampaignId[this];
        //    set => fields.MasterAccountCampaignId[this] = value;
        //}

        //[DisplayName("Master Account Company Name"), Expression("jMasterAccount.[CompanyName]")]
        //public String MasterAccountCompanyName
        //{
        //    get => fields.MasterAccountCompanyName[this];
        //    set => fields.MasterAccountCompanyName[this] = value;
        //}

        //[DisplayName("Master Account First Name"), Expression("jMasterAccount.[FirstName]")]
        //public String MasterAccountFirstName
        //{
        //    get => fields.MasterAccountFirstName[this];
        //    set => fields.MasterAccountFirstName[this] = value;
        //}

        //[DisplayName("Master Account Last Name"), Expression("jMasterAccount.[LastName]")]
        //public String MasterAccountLastName
        //{
        //    get => fields.MasterAccountLastName[this];
        //    set => fields.MasterAccountLastName[this] = value;
        //}

        //[DisplayName("Master Account Email"), Expression("jMasterAccount.[Email]")]
        //public String MasterAccountEmail
        //{
        //    get => fields.MasterAccountEmail[this];
        //    set => fields.MasterAccountEmail[this] = value;
        //}

        //[DisplayName("Master Account Domain"), Expression("jMasterAccount.[Domain]")]
        //public String MasterAccountDomain
        //{
        //    get => fields.MasterAccountDomain[this];
        //    set => fields.MasterAccountDomain[this] = value;
        //}

        //[DisplayName("Master Account Date"), Expression("jMasterAccount.[Date]")]
        //public DateTime? MasterAccountDate
        //{
        //    get => fields.MasterAccountDate[this];
        //    set => fields.MasterAccountDate[this] = value;
        //}

        //[DisplayName("Master Account Owner Id"), Expression("jMasterAccount.[OwnerId]")]
        //public Int32? MasterAccountOwnerId
        //{
        //    get => fields.MasterAccountOwnerId[this];
        //    set => fields.MasterAccountOwnerId[this] = value;
        //}
        ...
        public ClientSupressionRow()
            : base()
        {
        }

        public ClientSupressionRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            //public StringField MasterAccountCampaignId;
            //public StringField MasterAccountCompanyName;
            //public StringField MasterAccountFirstName;
            //public StringField MasterAccountLastName;
            //public StringField MasterAccountEmail;
            //public StringField MasterAccountDomain;
            //public DateTimeField MasterAccountDate;
            //public Int32Field MasterAccountOwnerId;
