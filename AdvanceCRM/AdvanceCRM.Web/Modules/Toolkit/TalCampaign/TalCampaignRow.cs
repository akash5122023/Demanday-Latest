...
{
    [ConnectionKey("Default"), Module("Toolkit"), TableName("[dbo].[TalCampaign]")]
    [DisplayName("Tal Campaign"), InstanceName("Tal Campaign")]
    [ReadPermission("TalCampaign:Read")]
    [InsertPermission("TalCampaign:Insert")]
    [UpdatePermission("TalCampaign:Update")]
    [DeletePermission("TalCampaign:Delete")]
    [LookupScript("TalCampaign.TalCampaign", Permission = "TalCampaign:Read")]
    public sealed class TalCampaignRow : Row<TalCampaignRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Agents Name"), ForeignKey("[dbo].[Users]", "UserId"), LeftJoin("jAgent"), TextualField("AgentDisplayName")]
        [Administration.UserEditor]
        public Int32? AgentsName
        {
            get => fields.AgentsName[this];
            set => fields.AgentsName[this] = value;
        }

        [DisplayName("Agent Display Name"), Expression("jAgent.[DisplayName]")]
        public String AgentDisplayName
        {
            get => fields.AgentDisplayName[this];
            set => fields.AgentDisplayName[this] = value;
        }

        [DisplayName("Reason"), Size(100)]
        ...
        public TalCampaignRow()
            : base()
        {
        }

        public TalCampaignRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField AgentDisplayName;
