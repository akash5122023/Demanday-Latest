...
{
    [ConnectionKey("Default"), Module("Toolkit"), TableName("[dbo].[DemandayCompetitor]")]
    [DisplayName("Demanday Competitor"), InstanceName("Demanday Competitor")]
    [ReadPermission("DemandayCompetitor:Read")]
    [InsertPermission("DemandayCompetitor:Insert")]
    [UpdatePermission("DemandayCompetitor:Update")]
    [DeletePermission("DemandayCompetitor:Delete")]
    [LookupScript("DemandayCompetitor.DemandayCompetitor", Permission = "DemandayCompetitor:Read")]
    public sealed class DemandayCompetitorRow : Row<DemandayCompetitorRow.RowFields>, IIdRow, INameRow
    {
        ...
        public DemandayCompetitorRow()
            : base()
        {
        }

        public DemandayCompetitorRow(RowFields fields)
            : base(fields)
        {
        }
